...
# title of job
title                           = Three-layers model (elastic waveguide)
...
ATTENUATION_f0_REFERENCE        = 100.0 # (Hz) relevant only if source is a Dirac or a Heaviside, otherwise it is f0 the dominant frequency of the source in the DATA/SOURCE file
...
nrec                            = 491            # number of receivers
xdeb                            = 260.d0        # first receiver x in meters
zdeb                            = 45.d0   # first receiver z in meters
xfin                            = 750.d0        # last receiver x in meters (ignored if only one receiver)
zfin                            = 45.d0   # last receiver z in meters (ignored if only one receiver)
...
1 1 2700.d0 5600.d0 3300.d0 0 0 9999 9999 0 0 0 0 0 0
2 1 2300.d0 3700.d0 1700.d0 0 0 9999 9999 0 0 0 0 0 0
3 1 2700.d0 4000.d0 2300.d0 0 0 9999 9999 0 0 0 0 0 0
