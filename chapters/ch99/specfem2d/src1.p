...
xs                              = 250.           # source location x in meters
zs                              = 45.           # source location z in meters
...
f0                              = 100.0            # dominant source frequency (Hz) if not Dirac or Heaviside
tshift                          = 0.0             # time shift when multi sources (if one source, must be zero)
anglesource                     = 0.0             # angle of the source (for a force only)
Mxx                             = 1.              # Mxx component (for a moment tensor source only)
Mzz                             = 0.7              # Mzz component (for a moment tensor source only)
